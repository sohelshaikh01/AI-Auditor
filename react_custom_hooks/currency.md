...
let newUrl = `https://cdn.jsdelivr.net/npm/@fawazahmed0/currency-api@latest/v1/currencies/inr.json`;
...
Change /currencies/{currencyCode}/{currencyCode} -> /currencies/{currencyCode}
